Tab01 <- sidebarLayout(
        sidebarPanel(
                ...
                wellPanel(
                        ...
                        selectInput(inputId = "color", label = "Category", choices = colorLevels, selected = "cm.analysis"),
                ...
                # tags$br(),
                wellPanel(
                        textInput(inputId = "calendarName", label = "Planner name", value = "Planner_work"),
                        # tags$br(),
                ...
                wellPanel(
                        ...
                        selectInput(inputId = "catfilt", label = "Category", choices = colorLevels, selected = "cm.analysis")
                ),
                tags$br(),
        ...
        mainPanel(
                #tags$h4("Why this app? 20200216: To structure, remember, and summarize your workday."),
