...
colorValues <- c(Other = cbPalette[1], 
                 cm.analysis = "#117755",
                 dada2cm = tol15rainbow[9],
                 `study directing` = tol15rainbow[7],
                 #literature_learn = "pink",
                 literature = "pink",
                 learn =  "#789885",
                 cbchab = "#E69F00",
                 gdmvis = "red", 
                 ...
                 kulbee = "#AAAA44",
                 pbibla = "#466D1D",
                 # gdmlac = tol15rainbow[10],
                 absolute_ab = tol15rainbow[15],
                 # essocc = "red",
                 micinv = "orange",
                 erfext = 'brown'
                 # cbmpre = "#E69F00",
