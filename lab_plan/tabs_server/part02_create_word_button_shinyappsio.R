...
observeEvent(input$create_word, {
    ...
    if (str_length(study_name) < 6){
        rv$infoText <- "study_name was not at lest six characters long, change!"
        return()
    }
    ...
    rv$infoText <- paste0("Lab table generated for choice combination ", c_protocol_name, " which refers to ", c_actual_protocol_name, ".", add_txt, " Word was made and would be ready to save.")
    # --
