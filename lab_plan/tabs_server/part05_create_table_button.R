...
observeEvent(input$create_labplan_table, {
    ...
    rv$infoText <- paste0("Lab table generated for choice combination ", c_protocol_name, " which refers to ", c_actual_protocol_name, ".", add_txt)
